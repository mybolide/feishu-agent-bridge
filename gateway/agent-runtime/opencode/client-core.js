...
const DEFAULT_PROGRESS_STALL_TIMEOUT_MS = 90 * 1000;
...
export const PROGRESS_STALL_TIMEOUT_MS = safeInt(process.env.OPENCODE_PROGRESS_STALL_TIMEOUT_MS, DEFAULT_PROGRESS_STALL_TIMEOUT_MS);
